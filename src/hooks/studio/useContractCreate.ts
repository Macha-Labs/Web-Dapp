...
const useContractCreate = (modal: any) => {
  ...
  const validateSteps = () => {
    if (formStep == 1) {
      if (contractDataRef.current["address"]?.value == "" || contractDataRef.current["address"]?.value == undefined || contractDataRef.current["chain_id"]?.value == "" || contractDataRef.current["chain_id"]?.value == undefined) {
        return false
      }
      else {
        return true
    ...
    if (formStep == 2) {
      if (contractDataRef.current["name"]?.value == "" || contractDataRef.current["name"]?.value == undefined || contractDataRef.current["slug"]?.value == "" || contractDataRef.current["slug"]?.value == undefined || contractDataRef.current["description"]?.value == "" || contractDataRef.current["description"]?.value == undefined || contractDataRef.current["image"]?.value == "" || contractDataRef.current["image"]?.value == undefined) {
        return false
      }
      else {
        return true
    ...
    if (formStep == 3) {
      if (contractDataRef.current["interested_events"]?.value == "" || contractDataRef.current["interested_events"]?.value == undefined || contractDataRef.current["interested_methods"]?.value == "" || contractDataRef.current["interested_methods"]?.value == undefined || contractDataRef.current["admins"]?.value == "" || contractDataRef.current["admins"]?.value == undefined) {
        return false
      }
      else {
        return true
  ...
  const publishContract = async () => {
    ...
    if (contractPayload.name == undefined || contractPayload.name == "" ||
      ...
      contractPayload.address == undefined || contractPayload.address == "" ||
      contractPayload.chain_id == undefined || contractPayload.chain_id == "" ||
      contractPayload.slug == undefined || contractPayload.slug == "" || contractPayload.image == undefined || contractPayload.image == "" || contractDataRef.current["interested_methods"].value == "" || contractDataRef.current["interested_methods"].value == undefined || contractDataRef.current["interested_events"].value == "" || contractDataRef.current["interested_events"].value == undefined || contractDataRef.current["admins"].value == "" || contractDataRef.current["admins"].value == undefined
    ) {
      toast({
        title: "Required fields cannot be empty",
        status: "warning",
