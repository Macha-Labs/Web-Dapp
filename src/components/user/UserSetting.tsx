  ...
  return (
    <>
      <Row>
              ...
              <div className="m-b-2">
                <ul>
                  <Button
                    ...
                    variant={
                      hookUserSetting.tab == "general" ? "state_3" : "state_1_2"
                    }
                    onClick={() => {
                      hookUserSetting.setTab("general");
                    }}
                  >
                    Profile
                  </Button>
                  <Button
                    className="menu-item w-100 m-b-0-5"
                    variant={
                      hookUserSetting.tab == "nfts" ? "state_3" : "state_1_2"
                    }
                    onClick={() => {
                      hookUserSetting.setTab("nfts");
                    }}
                  >
                    Collect NFTs
                  </Button>
        ...
        <StyledPageContainer>
          <div className="content">
            <StyledCard>{template()}</StyledCard>
          </div>
          <div className="close">
            <StyledIcon
              className="state-2-3"
