...
const ContractCreateEditModal = ({ modal, hookContractCreate, hookContract, isEdit }: Props) => {
    ...
    return (
        <ModalWindow
            ...
            header={
                <FlexRow width="100%" hrAlign="space-between">
                    <Text className="mb-0">{isEdit ? "Edit Contract" : "Create Contract"}</Text>
            ...
            footer={
                <FlexRow hrAlign="flex-end">
                    ...
                    >
                        ...
                        {(hookContractCreate.formStep > 1 && hookContractCreate.formStep != 4) && (
                            <ButtonNative
                        ...
                        {hookContractCreate.formStep < 3 && (
                            <ButtonNative
                                variant="state_brand"
                                marginTop={style.margin["lg"]}
                                onClick={isEdit ? hookContractCreate.nextFormEditStep : hookContractCreate.nextFormStep}
                            >
                                Next
                            </ButtonNative>
                        )}
                                ...
                                onClick={async (e: any) => {
                                    ...
                                    if (isEdit) {
                                        if (hookContract.contractDetails._id) {
                                            await hookContractCreate.editContract(hookContract.contractDetails?._id);
                                        }
                                    }
                                    else {
        ...
        >
            {(isEdit && (hookContract.isLoading || hookContract.contractDetails == undefined)) ? (
                  ...
                  #2448c7 73.45%
                        ...
                        {hookContractCreate.formStep == 1 && (
                            <>
                                ...
                                />
                                <InputSelect value={isEdit ? Number(hookContractCreate.$contractFormData.chain_id) : hookContractCreate.$contractFormData.chain_id} placeholder="Chain Id"
                        ...
                        {hookContractCreate.formStep == 4 && (
                            ...
                            >
                                ...
                                <Box>
                                    ...
                                    >
                                        Wait for approval from our side and your contract will be published.
                                    </Text>
                                </Box>
                            </Box>
                        )}
