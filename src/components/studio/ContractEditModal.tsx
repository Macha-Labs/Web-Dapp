...
const EditContractModal = ({ modal, hookContractCreate, hookContract }: Props) => {
  ...
  return (
          ...
          >
            ...
            {hookContractCreate.formStep < 3 && (
              <ButtonNative
                variant="state_brand"
                marginTop={style.margin["lg"]}
                onClick={hookContractCreate.nextFormEditStep}
              >
                Next
              </ButtonNative>
            )}
    ...
    >
        ...
        <FlexColumn hrAlign="space-between" height="35%">
          ...
          {hookContractCreate.formStep == 1 && (
            <>
              ...
              />
              <InputSelect value={Number(hookContractCreate.$contractFormData.chain_id)} placeholder="Chain Id"
      ...
      </FlexColumn>) : <FlexRow height="18rem">
        <Loader size="lg" />
      </FlexRow>}
    </ModalWindow>
  );
