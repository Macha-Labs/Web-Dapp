      ...
      {/* <FlexRow height="85vh">
        {hookCreatorCreate.step == 3 && (
          <Box
            ...
            alignItems="center"
          >
            <Image src="/assets/brand-sheildCheck.svg" alt="brand-sheildCheck.svg"/>
            <Text fontSize={`${style.font.h2}`} fontWeight={`${style.fontWeight.dark}`}>Congrats!</Text>
      ...
      <FlexRow height="85vh">
        {/* <Box width={"100%"} height={"100%"}>
          {hookCreatorCreate.step == 3 && (
            ...
            >
              <Image
                src="/assets/brand-sheildCheck.svg"
                alt="brand-sheildCheck.svg"
              />
              <Text
        ...
        <Flex direction="row">
          {hookCreatorCreate.step === 3 ? (
            // Display this flexRow when hookCreatorCreate.step is 2
            ...
            // Display other flexRow when hookCreatorCreate.step is not 2
            <FlexRow height="85vh">
