...
export const darkStyle = {
  ...
  icon: {
    bg: { 
      ...
      hover: 'linear-gradient(129.54deg, rgba(13, 33, 71, 0.66) 9.17%, rgba(11, 32, 73, 0.15) 94.25%)', 
      active: "",
  ...
  button: {
    bg: { 
      ...
      activeTranslucent: "linear-gradient(99.21deg, rgba(55, 121, 249, 0.66) 2.04%, rgba(28, 76, 244, 0.2) 95.15%);",
      disabled: "",
    }},
  shadowDropdown:
