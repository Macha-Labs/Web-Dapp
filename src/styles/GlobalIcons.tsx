const GlobalIcons: any = {
  ...
  "avatar-default": "/assets/icons/avatar-default.svg",
  "icon-dataNetwork":
  ...
  "icon-light-disconnectWallet": "/assets/icons/walletDisconnect-light.svg",
  "icon-switchWallet":
  ...
  "icon-brand-bolt": "/assets/icons/brand-bolt.svg",
  "icon-down":
  ...
  "icon-publisher-outline-light": "/assets/icons/publisher-outline-light.svg",
  ...
  "brand-twitter": "/assets/icons/Socials/light/brand-twitter-x.svg",
  ...
  "dark-twitter": "/assets/icons/Socials/dark/dark-twitter-x.svg",
